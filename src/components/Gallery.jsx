    ...
    <section className="py-16 bg-primary-red">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white font-poppins max-w-2xl mx-auto">
            {t('viewImages')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((image) => (
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-primary-red/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        {selectedImage && (
          <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
            <div className="relative max-w-5xl w-full max-h-full">
              ...
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 text-white hover:text-primary-yellow transition-colors duration-200 z-10"
              >
